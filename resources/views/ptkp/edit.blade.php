                ...
                <form action="{{ route('ptkp.update', $data->id) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kode" id="kode" class="@error('kode') is_invalid @enderror form-control" value="{{ $data->kode }}">
                            @error('kode')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ptkp_tahun" id="kode" class="@error('ptkp_tahun') is_invalid @enderror rupiah form-control" value="{{ $data->ptkp_tahun }}">
                            @error('ptkp_tahun')
                                <div class="mt-2 alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ptkp_bulan" id="kode" class="@error('ptkp_bulan') is_invalid @enderror rupiah2 form-control" value="{{ $data->ptkp_bulan }}">
                            @error('ptkp_bulan')
                                <div class="mt-2 alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
