...
<div class="head mt-5">
    <div class="flex gap-5 justify-between items-center">
        <div class="heading">
            <h2 class="text-2xl font-bold tracking-tighter">Tambah Pangkat Dan Golongan</h2>
...
<div class="body-pages">
    <div class="table-wrapping">
        <form action="{{ route('pangkat_golongan.store') }}" class="form-group" method="POST"
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-5 mt-5">
                <div class="input-box">
                    ...
                    <input type="text" name="pangkat" id="pangkat"
                        class="@error('pangkat') is-invalid @enderror form-input" value="{{ old('pangkat') }}">
                    @error('pangkat')
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="golongan" id="golongan"
                        class="@error('golongan') is-invalid @enderror form-input" value="{{ old('golongan') }}">
                    @error('golongan')
                    <div class="mt-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
