...
@section('content')
    <div class="card-header">
        <div class="card-header">
            <h5 class="card-title">Insert Data Migrasi SIBERANI</h5>
            <p class="card-title"><a href="/">Dashboard </a> > Insert Data Migrasi</p>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row m-0">
            <div class="col-md-12">
                ...
                <form action="{{ route('migrasi.store') }}" enctype="multipart/form-data" method="POST" class="form-group">
                    @csrf
                    <div class="row">
                        <div class="container">
