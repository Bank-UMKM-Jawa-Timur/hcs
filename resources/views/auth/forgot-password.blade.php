...
<head>
    ...
    <title>Human Capital System -   Ubah Password</title>
    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                @csrf
                <h2 class="text-center"><strong>Ubah</strong> password.</h2>
                @if (session('status'))
                ...
                <div class="form-group"><button class="btn btn-is-primary btn-block" type="submit">Simpan Perubahan</button></div>
            </form>
        </div>
    </div>
    <a href="/">
