    ...
    <script>
        ...
        function generatePendapatanItem(data) {
            ...
            if (data.gj_pokok > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.gj_pokok)}</td>
                    </tr>
                `
            }
            // T. Keluarga
            if (data.tj_keluarga > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_keluarga)}</td>
                    </tr>
                `
            }
            // Jabatan
            if (data.tj_jabatan > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_jabatan)}</td>
                    </tr>
                `
            }
            // Gaji Penyesuaian
            if (data.gj_penyesuaian > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.gj_penyesuaian)}</td>
                    </tr>
                `
            }
            // T. Perumahan
            if (data.tj_perumahan > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_perumahan)}</td>
                    </tr>
                `
            }
            // T. Telp, Listrik & Air
            if (data.tj_telepon > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_telepon)}</td>
                    </tr>
                `
            }
            // T. Pelaksana
            if (data.tj_pelaksana > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        <td align="left" class="px-3">Tj. Pelaksana</td>
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_pelaksana)}</td>
                    </tr>
                `
            }
            // T. Kemahalan
            if (data.tj_kemahalan > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_kemahalan)}</td>
                    </tr>
                `
            }
            // T. Kesejahteraan
            if (data.tj_kesejahteraan > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(data.tj_kesejahteraan)}</td>
                    </tr>
                `
            }
            // T. Teller
            ...
            if (tj_khusus > 0) {
                tableTunjangan += `
                    <tr style="border:1px solid #e3e3e3">
                        ...
                        <td class="text-end px-3">Rp ${formatRupiahPayroll(tj_khusus)}</td>
                    </tr>
                `
            }
        ...
        $('.show-data').on('click',function(e) {
            ...
            var tableTotalTunjanganTeratur = `
                <tr>
                    ...
                    <th class="text-end px-3">Rp ${formatRupiahPayroll(data.total_gaji)}</th>
                </tr>
            `
            ...
            var total_potongan = Math.round(data.bpjs_tk) + Math.round(data.potongan.dpp) + Math.round(kredit_koperasi) + Math.round(iuran_koperasi) + Math.round(kredit_pegawai) + Math.round(iuran_ik);
            var total_diterima = Math.round(data.total_gaji) - total_potongan;
            var potongan = ``;
            ...
            if (bpjs_tk > 0 ) {
                ...
                <tr style="border:1px solid #e3e3e3">
                    ...
                    <td id="gaji_pokok" class="text-end px-3">Rp ${formatRupiahPayroll(Math.round(data.bpjs_tk))}</td>
                </tr>`
            }
            if (potongan_dpp > 0) {
                potongan += `
                <tr style="border:1px solid #e3e3e3">
                    ...
                    <td id="gaji_pokok" class="text-end px-3">Rp ${formatRupiahPayroll(Math.round(data.potongan.dpp))}</td>
                </tr>`
            }
            if (kredit_koperasi > 0) {
                ...
                <tr style="border:1px solid #e3e3e3">
                    ...
                    <td id="gaji_pokok" class="text-end px-3">Rp ${formatRupiahPayroll(Math.round(data.kredit_koperasi))}</td>
                </tr>`
            }
            if (iuran_koperasi > 0) {
                potongan += `<tr style="border:1px solid #e3e3e3">
                    <td class="px-3">IUARAN KOPERASI	</td>
                    <td id="gaji_pokok" class="text-end px-3">Rp ${formatRupiahPayroll(Math.round(data.iuran_koperasi))}</td>
                </tr>`
            }
            if (kredit_pegawai > 0) {
                potongan += `
                <tr style="border:1px solid #e3e3e3">
                    ...
                    <td id="gaji_pokok" class="text-end px-3">Rp ${formatRupiahPayroll(Math.round(data.kredit_pegawai))}</td>
                </tr>`
            }
            if (iuran_ik > 0) {
                potongan += `
                <tr style="border:1px solid #e3e3e3">
                    ...
                    <td id="gaji_pokok" class="text-end px-3">Rp ${formatRupiahPayroll(Math.round(data.iuran_ik))}</td>
                </tr>`
            }
            ...
            var tableTotalPotongan = `
                <tr>
                    ...
                    <th class="text-end px-3">Rp ${formatRupiahPayroll(total_potongan.toString())}</th>
                </tr>
            `
            ...
            var tableTotalDiterima = `
                <tr class="bg-primary text-center text-white p-1 rounded ">
                    <th class="bg-red" colspan="2" width="40%">Total Gaji Yang Diterima <i>(Take Home Pay)</i></th>
                </tr>
                <tr>
                    <th width="40%">Jumlah</th>
                    <th class="text-end px-3">Rp ${totalGaji}</th>
                </tr
                <tr>
