...
<div class="head mt-5">
    <div class="flex gap-5 justify-between items-center">
        <div class="heading">
            <h2 class="text-2xl font-bold tracking-tighter">Edit Jabatan</h2>
                ...
                <form action="{{ route('jabatan.update', $data->kd_jabatan) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-5 mt-5">
                        <div class="input-box">
                            ...
                            <input type="text" name="kd_jabatan" id="kd_jabatan" class="@error('kd_jabatan') is-invalid @enderror form-input" value="{{ old('kd_jabatan', $data->kd_jabatan) }}">
                            @error('kd_jabatan')
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="nama_jabatan" id="nama_jabatan" class="@error('nama_jabatan') @enderror form-input" value="{{ old('nama_jabatan', $data->nama_jabatan) }}">
                            @error('nama_jabatan')
                                <div class="mt-2 alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
