...
@section('content')
    <div class="head mt-5">
        <div class="flex gap-5 justify-between items-center">
            <div class="heading">
                <h2 class="text-2xl font-bold tracking-tighter">Tambah Divisi</h2>
            ...
            <form action="{{ route('divisi.store') }}" method="POST" enctype="multipart/form-data" name="divisi" class="form-group">
                @csrf
                    <div class="input-box">
                        ...
                        <input type="text" class="@error('kode_divisi') is-invalid @enderror form-input" name="kode_divisi" id="kode_divisi"  value="{{ old('kode_divisi') }}">
                        @error('kode_divisi')
                    ...
                    <div class="input-box mt-5">
                        ...
                        <input type="text" class="@error('nama_divisi') is-invalid @enderror form-input" name="nama_divisi" id="nama_divisi" value="{{ old('nama_divisi') }}">
                        @error('nama_divisi')
                            <div class="mt-2 alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
