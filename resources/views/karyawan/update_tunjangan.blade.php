...
@section('content')
    <div class="card-header">
        <div class="card-header">
            <h5 class="card-title font-weight-bold">Update Tunjangan Karyawan</h5>
            <p class="card-title"><a href="">Manajemen Karyawan</a> > <a href="{{ route('karyawan.index') }}">Karyawan</a> > Update Tunjangan</p>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row m-0">
            <div class="col-md-12">
                ...
                <form action="{{ route('update_tunjangan') }}" enctype="multipart/form-data" method="POST" class="form-group">
                    @csrf
                    <div class="row">
