...
<div class="card-header">
  <div class="card-header">
      ...
      <p class="card-title"><a href="/">Dashboard </a> > <a href="{{ route('pengganti-biaya-kesehatan.index') }}">Penghasilan </a> > Import Tidak Teratur > Pengganti Biaya Kesehatan</p>
  </div>
  ...
  <div class="card-body">
      ...
      <form action="{{ route('pengganti-biaya-kesehatan.store') }}" method="POST" enctype="multipart/form-data">
          <div class="row m-0">
              @csrf
              ...
              <input type="hidden" name="id_tunjangan" class="form-control" value="17" required>
          </div>
