...
@section('content')
    <div class="head mt-5">
        <div class="flex gap-5 justify-between items-center">
            <div class="heading">
                <h2 class="text-2xl font-bold tracking-tighter">Edit Import Penghasilan</h2>
                <div class="breadcrumb">
                    <a href="{{ route('home') }}" class="text-sm text-gray-500 font-bold">Dashboard</a>
                    <i class="ti ti-circle-filled text-theme-primary"></i>
                    <a href="{{ route('penghasilan-tidak-teratur.index') }}"
                        class="text-sm text-gray-500 font-bold">Penghasilan Tidak Teratur</a>
                    <i class="ti ti-circle-filled text-theme-primary"></i>
                    <p class="text-sm text-gray-500 font-bold"> Edit Import Penghasilan Tidak Teratur</p>
                </div>
            </div>
            ...
            <div class="table-wrapping">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 mt-5 mb-5 items-end">
                    <div class="input-box">
                        ...
                        <select name="kategori" class="form-input" id="kategori" disabled>
                    ...
                    <div class="input-box">
                        ...
                        <input type="date" id="tanggal" class="form-input" name="tanggal" value="{{ \Carbon\Carbon::parse($old_created_at)->translatedFormat('Y-m-d') }}" required>
                    </div>
                    <div class="input-box">
                        <label for="file-penghasilan">Data Excel</label>
