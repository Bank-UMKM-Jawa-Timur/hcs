...
@section('content')
    <div class="head mt-5">
        <div class="flex gap-5 justify-between items-center">
            <div class="heading">
                <h2 class="text-2xl fontsdm.operation@bankumkm.id-bold tracking-tighter">Edit Penghasilan</h2>
                <div class="breadcrumb">
                    ...
                    <i class="ti ti-circle-filled text-theme-primary"></i>
                    <p class="text-sm text-gray-500 font-bold"> Edit Penghasilan Teratur</p>
                </div>
            </div>
