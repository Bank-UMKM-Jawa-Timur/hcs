    ...
    <div class="modal w-full my-3">
            ...
            <div class="modal-body">
                <div class="pb-4 flex justify-start">
                    <a href="" download class="btn btn-outline-excel mb-3 btn-download-rincian" data-batch="" type=""><iconify-icon icon="file-icons:microsoft-excel"></iconify-icon> Download Excel</a>
                </div>
               <div class="table-wrapping">
                <table class="tables-stripped w" id="table-rincian" style="width: 100%;">
