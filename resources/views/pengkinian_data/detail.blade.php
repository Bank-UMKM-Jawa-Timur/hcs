            ...
            <div class="modal-body">
                @if ($doks)
                    @if ($doks->foto_buku_nikah)
                        <img src="{{ asset('/upload/dokumen/pengkinian_data/' . $doks->pengkinian_id . '/' . $doks->foto_buku_nikah) }}"
    ...
    <div class="modal-layout hidden" id="foto-kartu-keluarga" tabindex="-1" aria-hidden="true">
        <div class="modal modal-sm">
            ...
            <div class="modal-body">
                @if ($doks)
                    @if ($doks->foto_kk)
                        <img src="{{ asset('/upload/dokumen/pengkinian_data/' . $doks->pengkinian_id . '/' . $doks->foto_kk) }}"
                            class="w-full max-w-3xl border" />
                    @else
                        <img src="{{ asset('style/assets/img/img-not-found.jpg') }}" class="max-h-60 max-w-60" />
                    @endif
    ...
    <div class="modal-layout hidden" id="foto-ktp" tabindex="-1" aria-hidden="true">
        <div class="modal modal-sm">
            ...
            <div class="modal-body">
                @if ($doks)
                    @if ($doks->foto_ktp)
                        <img src="{{ asset('/upload/dokumen/pengkinian_data/' . $doks->pengkinian_id . '/' . $doks->foto_ktp) }}"
...
@section('content')
    <div class="card-header">
        <div class="flex gap-5 justify-between items-center">
            <div class="heading">
                <h2 class="card-title font-weight-bold">Detail Pengkinian Data Karyawan</h2>
                <div class="breadcrumb">
                    <a href="#" class="text-sm text-gray-500">Manajemen Karyawan</a>
                    <i class="ti ti-circle-filled text-theme-primary"></i>
                    <a href="{{route('pengkinian_data.index')}}" class="text-sm text-gray-500">Pengkinian Data</a>
                    <i class="ti ti-circle-filled text-theme-primary"></i>
                ...
                <div class="p-5">
                    <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5  items-">
                        ...
                        <div class="profile-layout">
                            @if ($doks)
                                @if ($doks->foto_diri)
                                    <img src="{{ asset('/upload/dokumen/pengkinian_data/' . $doks->pengkinian_id . '/' . $doks->foto_diri) }}"
