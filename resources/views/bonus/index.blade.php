                            ...
                            <td class="flex justify-center gap-2">
                                @if ($item->is_lock != 1)
                                    ...
                                    @else
                                        ...
                                        @endcan
                                        @can('penghasilan - edit - bonus')
                                            <a href="{{ route('edit-tunjangan-bonus', $item->id_tunjangan)}}?tanggal={{\Carbon\Carbon::parse($item->new_date)->translatedFormat('Y-m-d')}}&entitas={{$item->kd_entitas}}" class="btn btn-warning-light">Edit</a>
                                        @endcan
                                    @endif
                                @else
