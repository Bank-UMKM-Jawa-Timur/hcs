...
<div class="card-header">
  <div class="card-header">
      ...
      <p class="card-title"><a href="/">Dashboard </a> > <a href="">Penghasilan </a> > Import Tidak Teratur > THR</p>
  </div>
  ...
  <div class="card-body">
      ...
      <form action="{{ route('thr.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
          <div class="row m-0">
