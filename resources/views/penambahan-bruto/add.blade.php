            ...
            <div class="col">
                <form action="{{ route('penambahan-bruto.store') }}" method="POST" enctype="multipart/form-data" name="cabang" class="form-group" >
                    ...
                    <input type="text" class="@error('jkk') is-invalid @enderror form-control" name="jkk" id="jkk"
                        value="{{ old('jkk') }}" onkeyup="hitungTotal()" required>
                    @error('jkk')
                        <div class="mt-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <input type="text" class="@error('jht') is-invalid @enderror form-control" name="jht" id="jht" value="{{ old('jht') }}" required>
                    @error('jht')
                        <div class="mt-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <input type="text" class="@error('jkm') is-invalid @enderror form-control" name="jkm" id="jkm"
                        value="{{ old('jkm') }}" onkeyup="hitungTotal()" required>
                    @error('jkm')
                        <div class="mt-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <input type="text" class="@error('kesehatan') is-invalid @enderror form-control" name="kesehatan" id="kesehatan"
                        value="{{ old('kesehatan') }}" onkeyup="hitungTotal()" required>
                    @error('kesehatan')
                        <div class="mt-2 alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <input type="text" class="@error('kesehatan_batas_atas') is-invalid @enderror form-control" name="kesehatan_batas_atas" id="kesehatan_batas_atas" value="{{ old('kesehatan_batas_atas') }}" required>
                    ...
                    <input type="text" class="@error('kesehatan_batas_bawah') is-invalid @enderror form-control" name="kesehatan_batas_bawah" id="kesehatan_batas_bawah" value="{{ old('kesehatan_batas_bawah') }}" required>
                    ...
                    <input type="text" class="@error('jp') is-invalid @enderror form-control" name="jp" id="jp"
                        value="{{ old('jp') }}" onkeyup="hitungTotal()" required>
                    @error('jp')
                        <div class="mt-2 alert alert-danger">{{ $message }}</div>
                    @enderror
