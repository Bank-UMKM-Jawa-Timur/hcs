    ...
    e.fn.perfectScrollbar = function (n, r) {
        return this.each(function () {
            var l = e.extend(!0, {}, t),
                a = e(this);
            if (
                ("object" == typeof n ? e.extend(!0, l, n) : (r = n),
                "update" === r)
            )
                return (
            ...
            var s,
                ...
                X = o(),
                Y =
                    parseInt(g.css("borderLeftWidth"), 10) +
                    parseInt(g.css("borderRightWidth"), 10),
                P =
                    parseInt(g.css("borderTopWidth"), 10) +
                    parseInt(g.css("borderBottomWidth"), 10),
                k = function (e, t) {
                    var o = e + t,
                        n = d - h;
                    b = 0 > o ? 0 : o > n ? n : o;
                ...
                M = function (e) {
                    return (
                        l.minScrollbarLength &&
                            (e = Math.max(e, l.minScrollbarLength)),
                        l.maxScrollbarLength &&
                ...
                W = function () {
                    ...
                    C
                        ? (t.right = D
                              ? u - a.scrollLeft() - S - T.outerWidth()
                              : S - a.scrollLeft())
                        : (t.left = D
                              ? a.scrollLeft() + 2 * c - u - x - T.outerWidth()
                              : x + a.scrollLeft()),
                        m.css(t),
                        w.css({ left: v, width: f - Y }),
                        T.css({ top: b, height: h - P }),
                        s
                            ? a.addClass("ps-active-x")
                            : a.removeClass("ps-active-x"),
                        i
                            ? a.addClass("ps-active-y")
                            : a.removeClass("ps-active-y");
                },
                j = function () {
                    g.hide(),
                        m.hide(),
                        ...
                        !l.suppressScrollX && u > c + l.scrollXMarginOffset
                            ? ((s = !0),
                              (f = M(parseInt((c * c) / u, 10))),
                              (v = parseInt(
                                  (a.scrollLeft() * (c - f)) / (u - c),
                                  10
                              )))
                            : ((s = !1), (f = 0), (v = 0), a.scrollLeft(0)),
                        !l.suppressScrollY && p > d + l.scrollYMarginOffset
                            ? ((i = !0),
                              (h = M(parseInt((d * d) / p, 10))),
                              (b = parseInt(
                                  (a.scrollTop() * (d - h)) / (p - d),
                                  10
                              )))
                            : ((i = !1), (h = 0), (b = 0), a.scrollTop(0)),
                        b >= d - h && (b = d - h),
                        v >= c - f && (v = c - f),
                        W(),
                    ...
                    var e = !1,
                        t = function (e) {
                            ...
                            return (
                                (t === void 0 || o === void 0) &&
                                    ((t =
                                        (-1 * e.originalEvent.wheelDeltaX) / 6),
                                ...
                                t !== t &&
                                    o !== o &&
                                    ((t = 0), (o = e.originalEvent.wheelDelta)),
                                [t, o]
                            );
                        },
                        o = function (o) {
                                ...
                                l.useBothWheelAxes
                                    ? i && !s
                                        ...
                                        : s &&
                                          ...
                                          (e = !0))
                                    : (a.scrollTop(
                                          a.scrollTop() - c * l.wheelSpeed
                                      ),
                                      a.scrollLeft(
                                          a.scrollLeft() + r * l.wheelSpeed
                                      )),
                                j(),
                                (e = e || A(r, c)),
                ...
                Q = function () {
                    ...
                    e(window).bind("touchstart" + X, function () {
                        ...
                        a.bind("touchmove" + X, function (e) {
                            if (
                                !s &&
                                1 === e.originalEvent.targetTouches.length
                            ) {
