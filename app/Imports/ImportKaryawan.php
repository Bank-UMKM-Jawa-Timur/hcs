            ...
            foreach($rows as $row){
                ...
                DB::table('mst_karyawan')
                    ->insert([
                        ...
                        'sk_pemberhentian' => $row['sk_pemberhentian'],
                        'created_at' => now(),
                    ]);

                if (property_exists($row, 'tunjangan_keluarga')) {
                ...
                if (property_exists($row, 'tunjangan_telepon_air_listrik')) {
                ...
                if (property_exists($row, 'tunjangan_jabatan')) {
                ...
                if (property_exists($row, 'tunjangan_teller')) {
                ...
                if (property_exists($row, 'tunjangan_perumahan')) {
                ...
                if (property_exists($row, 'tunjangan_kemahalan')) {
                ...
                if (property_exists($row, 'tunjangan_pelaksana')) {
                ...
                if (property_exists($row, 'tunjangan_kesejahteraan')) {
                ...
                if (property_exists($row, 'tunjangan_dpp')) {
